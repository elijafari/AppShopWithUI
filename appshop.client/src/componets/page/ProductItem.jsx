...
<div className="col-md-3 col-lg-3 col-sm-6 mb-4">
  ...
  <div className="card product-card h-100 d-flex flex-column justify-content-between text-center">
    {/* تصویر */}
    <img
    ...
    <div className="card-body d-flex flex-column justify-content-between">
      {/* نام محصول */}
      <h6 className="card-title fw-bold product-title">{product.name}</h6>
